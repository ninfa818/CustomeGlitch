...
public class PreviewActivity extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.btnshareimg.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (ImportImageActivity.imgvid == 0) {
                    Intent intent = new Intent("com.laodev.mediaeditor.fileProvider");
                    Uri uriForFile = FileProvider.getUriForFile(PreviewActivity.this.getApplicationContext(), "com.laodev.mediaeditor.fileProvider", new File(PreviewActivity.this.uri.toString()));
        ...
        this.facebook.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (!PreviewActivity.this.check("com.facebook.katana")) {
                    ...
                    Uri uriForFile = FileProvider.getUriForFile(PreviewActivity.this, "com.laodev.mediaeditor.fileProvider", new File(PreviewActivity.this.uri.toString()));
